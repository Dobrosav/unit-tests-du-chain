...
public class Lexer {
	...
	// KljuÄ�ne reÄ�i koje mogu da uÄ‘u u sastav definicije/deklaracije
	...
	// Provera da li je zadata reÄ� konstanta
	...
	// Provera da li promenljiva sadrÅ¾i kljuÄ�nu reÄ� "this"
	public boolean hasThis(String var) {
		if (var.contains("this")) return true;
		return false;
	}
	
	// Dohvata objekat Ä�ijim poljima se pristupa
