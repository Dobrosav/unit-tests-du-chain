...
public class Scope {
	...
	// MoguÄ‡i tipovi opsega u programu
	public static enum ScopeType { REGULAR, LOOP, IF_ELSE, SWITCH, CASE, FUNCTION, CLASS }
	
	// Opsezi se zbog lakÅ¡eg snalaÅ¾enja identifikuju svojim id-jem
	...
	// PoÄ?etna i krajnja linija opsega 
	private int rowStart, rowEnd;
	
	// Flagovi koji oznaÄ?avaju da li je opseg do-while/else/default, kao i da li se sastoji iz samo 1 naredbe
